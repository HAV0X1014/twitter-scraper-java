...
public class SelfUser {
    ...
    public static SelfUser fromJson(JsonHelper h, JsonObject z) {
        var o = new SelfUser();
        h.set(z);
        o.defaultProfile = h.has("default_profile") ? h.bool("default_profile") : null;
        o.defaultProfileImage = h.has("default_profile_image") ? h.bool("default_profile_image") : null;
        o.description = h.string("description");
        o.entities = LegacyUser.Entities.fromJson(h, h.object("entities"));
        h.set(z);
        o.fastFollowersCount = h.has("fast_followers_count") ? h.integer("fast_followers_count") : null;
        ...
        o.hasCustomTimelines = h.has("has_custom_timelines") ? h.bool("has_custom_timelines") : null;
        o.isTranslator = h.bool("is_translator");
        o.listedCount = h.has("listed_count") ? h.integer("listed_count") : null;
        o.mediaCount = h.integer("media_count");
        o.needsPhoneVerification = h.has("needs_phone_verification") ? h.bool("needs_phone_verification") : null;
        o.normalFollowersCount = h.has("normal_followers_count") ? h.integer("normal_followers_count") : null;
        ...
        o.wantRetweets = h.has("want_retweets") ? h.bool("want_retweets") : null;
        ...
        o.birthdate = h.has("birthdate") ? Birthdate.fromJson(h, h.object("birthdate")) : null;
        h.set(z);
