...
public class SelfUser {
    ...
    public static SelfUser fromJson(JsonHelper h, JsonObject z) {
        var o = new SelfUser();
        h.set(z);
        o.defaultProfile = h.bool("default_profile", false);
        o.defaultProfileImage = h.bool("default_profile_image", false);
        o.description = h.string("description");
        o.entities = LegacyUser.Entities.fromJson(h, h.object("entities"));
        h.set(z);
        o.fastFollowersCount = h.integer("fast_followers_count", -1);
        ...
        o.hasCustomTimelines = h.bool("has_custom_timelines", false);
        o.isTranslator = h.bool("is_translator");
        o.listedCount = h.integer("listed_count", -1);
        o.mediaCount = h.integer("media_count");
        o.needsPhoneVerification = h.bool("needs_phone_verification", false);
        o.normalFollowersCount = h.integer("normal_followers_count", -1);
        ...
        o.wantRetweets = h.bool("want_retweets", false);
